...
public class WidgetConfig {
    ...
    public int getUpdatePeriodMillis() { return updatePeriodMillis; }
    public String getPreviewImage() { return previewImage; }
    public String getResizeMode() { return resizeMode; }
    public String getWidgetCategory() { return widgetCategory; }

    public void setPreviewImage(String previewImage) { this.previewImage = previewImage; }
    public void setResizeMode(String resizeMode) { this.resizeMode = resizeMode; }
    public void setWidgetCategory(String widgetCategory) { this.widgetCategory = widgetCategory; }
}
